...
import { X, Download, Copy, Check, Sparkles, BookOpen, AlertTriangle, CheckCircle, Shield } from 'lucide-react';

export default function DraftInspectorModal({ grant, draft, onClose }) {
        ...
        <div style={{
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.25rem' }}>
              ...
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.8rem', color: '#A1A1AA' }}>
                {grant.agency || 'Federal Agency'} • ID: {grant.grant_id || grant.id}
              </span>
            </div>
            <h2 className="font-heading" style={{ fontSize: '1.9rem', lineHeight: '1' }}>
              {grant.title}
            </h2>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <button onClick={onClose} style={{ background: 'transparent', border: 'none', color: '#FFFFFF', cursor: 'pointer', padding: '0.25rem' }}>
              <X size={26} />
            </button>
          </div>
        </div>

        {/* Modal Content — Dual Column Workstation */}
        <div style={{
          display: 'grid',
          ...
          {/* Left Column: 5-Dimension Radar & RAG Citations */}
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ fontSize: '0.8rem', color: 'var(--ink-muted)', lineHeight: '1.4' }}>
                Evaluated against Youth Education Alliance organizational profile and 990 financial filings.
              </p>
            </div>

            {/* 5-Dimension Rubric Meters */}
            ...
            {[
              ...
              { label: 'Eligibility Fit', score: score.eligibility_fit || 24, max: 25, note: '501(c)(3) verified' },
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      backgroundColor: isActive ? 'var(--canvas-bg)' : 'transparent',
